-- =====================================================
-- LIKES SYSTEM SETUP FOR FEED POSTS
-- =====================================================
...
-- 3. CREATE UNIQUE CONSTRAINT TO PREVENT DUPLICATE LIKES
...
ALTER TABLE likes DROP CONSTRAINT IF EXISTS unique_user_reel_like;
...
ALTER TABLE likes 
    ADD CONSTRAINT unique_user_reel_like 
...
-- 2. ✅ Foreign key relationships to users, posts, comments, reels

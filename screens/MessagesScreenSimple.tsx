          ...
          <View style={styles.headerContent}>
            ...
            {__DEV__ && (
              <TouchableOpacity 
                ...
                onPress={async () => {
                  const { testSupabaseConnection, checkNetworkConnectivity } = await import('@/utils/connectionTest');
                  ...
                  Alert.alert(
                    ...
                    `Network: ${networkResult.success ? '✅' : '❌'} ${networkResult.internet || networkResult.error}\n\nSupabase: ${supabaseResult.success ? '✅' : '❌'} ${supabaseResult.message || supabaseResult.error}\n\nCurrent Status:\n- Network: ${networkStatus ? '✅' : '❌'}\n- Supabase: ${supabaseConnected ? '✅' : '❌'}\n- Overall: ${isConnected ? '✅' : '❌'}`,
                    [{ text: 'OK' }]
                  );
                }}
              >
